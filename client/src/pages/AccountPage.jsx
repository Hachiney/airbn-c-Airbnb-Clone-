...
export default function AccountPage() {
    ...
    function getStyle(type=null) {
        let style = 'border py-2 px-4 rounded-full inline-flex gap-2';
        if (type===subpage) {
