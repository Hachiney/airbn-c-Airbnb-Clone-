...
export default function Header() {
  const {user} = useContext(UserContext);
    return(
      ...
      <Link to={user? '/account/profile': '/login'} className='flex gap-3 border border-gray-300 rounded-full px-4 py-2 shadow-md shadow-gray-300 gap-'>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
          <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="gray" className="w-6 h-6 bg-gra">
